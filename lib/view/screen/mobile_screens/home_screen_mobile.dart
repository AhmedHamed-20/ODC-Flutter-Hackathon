      ...
      builder: (context, state) {
        ...
        return Scaffold(
          body: generalCubit.loadAllProudctsData
              ...
              : ConditionalBuilder(
                  builder: (context) {
                    generalCubit.logOut(context);
                    return const SizedBox();
                  },
                  condition: generalCubit.tokenExpired,
                  fallback: (context) {
                    return Column(
                      children: [
                        Flexible(
                                ...
                                child: cardProduct(
                                  ...
                                  addToCartCallBack: () {
                                    generalCubit.addToCard({
                                      'proudctId':
                                          generalCubit.getIdBetweenModles(
                                              generalCubit.currentHomeTabIndex,
                                              index),
                                      'name': generalCubit
                                          .getNameOProudctBetweenModels(
                                      ...
                                      'imageUrl': generalCubit
                                          .getPhotoofProudctBetweenModels(
                                              ...
                                              index),
                                      'amount':
                                          generalCubit.getAmountBetweenModles(
                                              generalCubit.currentHomeTabIndex,
                                              index),
                                    });
                                  },
                                  ...
                                  minusCallBck: () {
                                    ...
                                    generalCubit.changeCartCountNumber(
                                        true,
                                        generalCubit.currentHomeTabIndex,
                                        index);
                                  },
